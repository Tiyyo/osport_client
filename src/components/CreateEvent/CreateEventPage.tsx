...
function CreateEvent() {
  return (
    <>
      <Header />
      <Menu />
      <div className="flex flex-col items-center m-4 sm:w-4/5 sm:p-4 sm:m-auto sm:shadow-xl sm:border sm:rounded-xl sm:border-gray-700 sm:pb-4 sm:mt-4 gap-4 mb-24 sm:mb-16">
        <CreateEventForm />
