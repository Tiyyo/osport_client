...
function Menu() {
  return (
    <nav className="flex w-full justify-center gap-2 py-2 fixed bottom-0 bg-neutral bg-opacity-80 sm:relative sm:-top-16 sm:w-fit sm:m-auto sm:bg-opacity-0 z-10">
