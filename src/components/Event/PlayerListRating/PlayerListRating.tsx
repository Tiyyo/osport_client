...
function PlayerListRating({
  ...
  async function rateUser(userRating: number, playerToRateId: number) {
    try {
      const res = await axiosInstance.patch('user/sport', {
  ...
  return (
    <div className="flex flex-col items-center py-8 bg-neutral-focus p-4 shadow-sm border rounded-xl border border-base-300 w-full h-full">
      ...
      <TeamResult
        scoreTeam1={firstTeamScore}
        scoreTeam2={secondTeamScore}
        team="Team 1"
      />
      ...
      <TeamResult
        scoreTeam1={secondTeamScore}
        scoreTeam2={firstTeamScore}
        team="Team 2"
      />
        ...
        <form
          ...
          <div className="flex justify-center w-full">
            ...
            <button
              ...
              className={
                userIdToRate === userId
                  ? 'btn btn-disabled btn-lg m-0 rounded-l-none'
                  : 'btn btn-lg m-0 rounded-l-none'
              }>
              Rate
            </button>
          </div>
