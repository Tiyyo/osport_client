...
function Chat() {
  return (
    <div className="bg-neutral-focus shadow-xl border rounded-xl border-gray-700 w-full">
      ...
      <div className="flex flex-col-reverse gap-2 p-2 overflow-y-auto w-full min-h-0 bg-neutral-focus h-[60vh] shadow-xl border rounded-xl border-gray-700 rounded-b-none border-t-0 sm:h-[50vh]">
